...
From the below two functions, the dimensions of the dataset: 24651 rows, 23 columns where all but one column are character type and one is a date-time type. The variables read in do not contain any labels and as neither variable is a factor type, there are no factor levels to report. 
