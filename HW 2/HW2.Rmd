...
df100k_norm <- df100k_norm %>% 
  select(-c(Country,Order.ID)) #Country,
```
...
#mean absolute error
mae(predictions$Total.Revenue, predictions$...1)

#rmse Root Mean Squared Error
rmse(predictions$Total.Revenue, predictions$...1)

#r squared
SSE <- sum((predictions$Total.Revenue - predictions$...1)^2)
SST <- sum((predictions$Total.Revenue - mean(predictions$Total.Revenue))^2)
R_squared <- 1 - (SSE / SST)
